...
# Выносит конструирование объекта за пределы его собственного класса,
# поручив это дело отдельным объектам - строителям, которые вызываются
# по очереди с разными параметрами.

# ДИРЕКТОР Можно выделить вызовы методов строителя в отдельный класс - директор.
# Он будет задавать порядок шагов строительства, а строитель — выполнять их.
